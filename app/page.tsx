        ...
        <div className="max-w-3xl mx-auto px-6 py-20">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                q: 'AnkiやDuolingoと何が違いますか？',
                a: 'Ankiはカード作成・例文・画像をすべて自分で用意する必要があります。NeoVocabはAIが自動生成するため、登録のハードルがゼロです。Duolingoと異なり、自分だけの単語帳を作れます。',
              },
              {
                q: '対応している言語は？',
              ...
              },
              {
                ...
                a: '月あたり例文生成450回、画像生成100回の上限があります。通常の学習では上限に達することはほとんどありません。上限はダッシュボードでいつでも確認できます。',
              },
            ].map(({ q, a }, i) => (
              <div
                key={i}
